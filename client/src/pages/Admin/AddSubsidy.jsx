...
export default function AddSubsidy() {
...
console.log(data);
      axios.post("http://localhost:5000/subsidy/add-subsidy",data)
      .then(response=>{
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              <div class="form-group">
                    ...
                    <select class="form-control" id="exampleSelect1"  name='data' onChange={inputChange} value={subsidy.card_type} required>
              ...
              <div className="row">
                ...
                <div className="form-group col-md-3">
                  ...
                  name='price' value={subsidy.price1} onChange={(event) =>
                    handleInputChange(index, event)} required/>
                </div>
